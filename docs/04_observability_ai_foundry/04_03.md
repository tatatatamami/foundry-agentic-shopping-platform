...
Select **Next** to continue to the **Field mapping** page. On this page, ensure that <!-- {% raw %} --> `{{item.expected_domain}}` <!-- {% endraw %} --> is the selected value for **Ground truth** and then select **Next.**
