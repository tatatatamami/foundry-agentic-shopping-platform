...
{: .note }
> If you are using an arm64-based machine, you will need to build the container image in linux/amd64 mode in order to deploy this to Azure Application Services. You can do so via ACR build using the following command from the root of your repository:
