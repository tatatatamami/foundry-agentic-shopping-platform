...
application_insights_connection_string = os.getenv("APPLICATIONINSIGHTS_CONNECTION_STRING", "").strip()
if application_insights_connection_string:
    try:
        configure_azure_monitor(connection_string=application_insights_connection_string)
        OpenAIInstrumentor().instrument()
    except Exception as telemetry_error:
        print(f"Warning: telemetry is disabled due to configuration error: {telemetry_error}")
else:
    print("Warning: APPLICATIONINSIGHTS_CONNECTION_STRING is empty; telemetry is disabled.")
        ...
        while True:
            ...
            try:
                ...
                if agent_name in ["interior_designer", "interior_designer_create_image", "cora"]:
                    ...
                    if image_data:
                        # Add visual context to search (e.g., "blue living room" 竊・search for blue paint)
