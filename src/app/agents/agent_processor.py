...
if application_insights_connection_string:
    try:
        ...
        print(f"Warning: telemetry is disabled in agent_processor: {telemetry_error}")
else:
    print("Warning: APPLICATIONINSIGHTS_CONNECTION_STRING is empty; telemetry is disabled in agent_processor.")
