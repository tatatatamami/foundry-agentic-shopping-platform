...
class A2AServer:
    ...
    def _setup_server(self) -> None:
        """Setup A2A request handling and Starlette app."""
    ...
    def _get_agent_card(self) -> AgentCard:
        """Build the A2A Agent Card metadata."""
        ...
        skill_product_helper = AgentSkill(
            ...
            description=(
                "Handles customer inquiries about Zava products, including features, pricing, "
                "and ranking products based on customer needs."
            ),
    ...
    def get_starlette_app(self):
        """Return the built A2A Starlette app for FastAPI mounting."""
